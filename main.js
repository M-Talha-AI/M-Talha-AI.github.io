...
$(document).ready(function() {
    ...
    // Theme toggle — class lives on <html> so the initial theme can be applied
    ...
    // Follow the OS theme on later changes, but only until the user has made an
    // explicit choice (stored in localStorage).
